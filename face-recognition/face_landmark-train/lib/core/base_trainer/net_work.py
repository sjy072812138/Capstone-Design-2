    ...
    for epoch in range(self.epochs):
      ...
      training_massage = 'Epoch: %d, ' \
                         ...
                         'Time consume: %.2f'%(epoch,
                                               train_total_loss / (num_train_batches+1),
                                               test_total_loss / (num_test_batches+1),
      ...
      current_model_saved_name=os.path.join(cfg.MODEL.model_path, 'saved')
      ...
      tf.saved_model.save(self.model, "./model/saved")
